...
public class SharedObject implements Serializable, SharedObject_itf {
	...
	private boolean is_used() {
		return ((this.lockState == LockState.RLT) || (this.lockState == LockState.WLT));//|| (this.lockState == LockState.RLT_WLC));
	}
    ...
    public void lock_read() {
    	...
    	synchronized(this) {
	    	switch (this.lockState) {
	    		...
	    		case WLT: //Erreur
	    		case RLT_WLC: //Erreur
	    			Debug.exit("lock_read invalide: forgotten unlock");
	    	}
	    }
    ...
    public void lock_write() {
    	...
    	synchronized(this) {
	    	switch (this.lockState) {
	    		...
	    		case RLT: //Erreur
	    		case RLT_WLC: //Erreur
	    			Debug.exit("lock_write invalide: forgotten unlock");
	    	}
    	}
    ...
    public synchronized void unlock() {
    	...
    	switch(this.lockState) {
    		...
    		case RLC: //Erreur
    		case NL: //Erreur
    			Debug.exit("unlock invalide: forgotten lock");
    	}
    ...
    public synchronized Object reduce_lock() {
    	...
    	switch(this.lockState) {
    		...
    		case RLC: //Erreur
    		case NL: //Erreur
    			Debug.exit("reduce_lock invalide: invalid states");
    	}
    ...
    public synchronized void invalidate_reader() {
    	...
    	switch(this.lockState) {
    		...
    		case WLC: //Erreur
    		case NL: //Erreur
    			Debug.exit("invalidate_reader invalide: invalid states");
    	}
    ...
    public synchronized Object invalidate_writer() {
    	...
    	switch(this.lockState) {
    		...
    		case RLC: //Erreur
    		case NL: //Erreur
    			Debug.exit("invalidate_writer invalide: invalid states");
    	}
